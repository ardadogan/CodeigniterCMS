...
<div class="row tophdr">
	<div class="col-md-6">
		<h2><span><?=$categoryName;?></span> Kategorisini Düzenle</h2>
	</div>
	<div class="col-md-6 text-right">
		
		<?=btn_save('data_form');?>
		<?=btn_back('product/category/'.$category->parentId);?>
...
<?php
	if(isset($_GET['show_message'])){
		block_message($categoryName.' Kategorisi Oluşturuldu','Kategori ile ilgili güncelleme işlemlerini buradan yapabilirsiniz');
	}
?>
	...
	<div class="col-md-12">
		...
		<div class="panel panel-primary" data-collapsed="0">
			...
			<div class="panel-body">
				...
				<form role="form" method="post" class="form-horizontal form-groups-bordered validate" id="data_form" action="<?=base_url('product/category/update/'.$category->categoryId);?>" enctype="multipart/form-data" onsubmit="return false; form_gonder('data_form')" >
						...
						<div class="col-sm-5" >
							...
							<?php
								...
								image_uploader(array(
										...
										'currentImg' => app_url('assets/images/product/category/'.$category->image),
										'inputName' => 'file',
									));
							?>
