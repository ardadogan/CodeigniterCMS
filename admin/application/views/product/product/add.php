<div class="row tophdr">
	<div class="col-md-6">
		<h2><span><?=$category->name?></span> Kategorisine Yeni Ürün Ekle </h2>
	</div>
	<div class="col-md-6 text-right">
		
		<?=btn_save('data_form');?>
		<?=btn_back('product/product/'.$category->categoryId);?>
	...
	<div class="col-md-12">
		...
		<div class="panel panel-primary" data-collapsed="0">
			...
			<div class="panel-body">
				...
				<form role="form" method="post" class="form-horizontal form-groups-bordered validate" id="data_form" action="<?=base_url('product/product/create/'.$category->categoryId);?>" enctype="multipart/form-data" onsubmit="return false; form_gonder('data_form')" >
	...
	function form_gonder(form_id){
		...
		jQuery.ajax({
			...
			success     : function(data, textStatus, jqXHR){
				...
				if(data.status){
					app.redirect('product/product/edit/'+data.productId+'?show_message=true',1);
				}
